...
func Load() *Config {
	return &Config{
		...
		ActivityCheckEnabled:     getEnv("ACTIVITY_CHECK_ENABLED", "false") == "true",
		...
		ActivityCheckChannel:     getEnv("ACTIVITY_CHECK_CHANNEL", "attendance-oa"),
	}
}
