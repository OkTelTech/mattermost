            ...
            bot_accounts: {
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        {
                            type: 'text',
                            key: 'ServiceSettings.BotServiceURL',
                            label: defineMessage({id: 'admin.service.botServiceURLTitle', defaultMessage: 'Bot Service URL:'}),
                            help_text: defineMessage({id: 'admin.service.botServiceURLDescription', defaultMessage: 'The URL of the bot microservice used for attendance and other bot features. Example: http://localhost:3001'}),
                            placeholder: defineMessage({id: 'admin.service.botServiceURLPlaceholder', defaultMessage: 'E.g.: http://localhost:3001'}),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.BOT_ACCOUNTS)),
                        },
                    ],
                },
